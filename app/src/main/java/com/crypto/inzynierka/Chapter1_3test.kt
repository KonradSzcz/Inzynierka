...
import com.crypto.inzynierka.databinding.FragmentChapter13TestBinding

class Chapter1_3test : Fragment() {
    private var _binding: FragmentChapter13TestBinding? = null
    ...
    private fun loadQuestionsFromDB() {
        ...
        val cursor: Cursor = db.rawQuery("SELECT * FROM ${DBConnection.TABLE_NAME_QUESTIONS} where Chapter= 'chapter13'", null)
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter13TestBinding.inflate(inflater, container, false)
        return binding.root
    }

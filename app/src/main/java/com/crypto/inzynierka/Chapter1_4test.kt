...
import com.crypto.inzynierka.databinding.FragmentChapter14testBinding

class Chapter1_4test : Fragment() {
    private var _binding: FragmentChapter14testBinding? = null
    ...
    private fun loadQuestionsFromDB() {
        ...
        val cursor: Cursor = db.rawQuery("SELECT * FROM ${DBConnection.TABLE_NAME_QUESTIONS} where Chapter= 'chapter14'", null)
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter14testBinding.inflate(inflater, container, false)
        return binding.root
    }

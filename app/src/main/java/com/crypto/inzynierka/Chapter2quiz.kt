...
import com.crypto.inzynierka.databinding.FragmentChapter2quizBinding

class Chapter2quiz : Fragment() {
    private var _binding: FragmentChapter2quizBinding? = null
    ...
    private fun loadQuestionsFromDB(chapter: Int) {
        ...
        val chapterColumn = "chapter2$chapter"  // Dynamiczne określenie kolumny rozdziału
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter2quizBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun saveResult() {
        ...
        val cursor = db.rawQuery(
            ...
            arrayOf("chapter2", CurrentChapter.toString())
        )

        if (!cursor.moveToFirst()) {
            // Jeśli nie ma rekordu, wstaw nowy
            val values = ContentValues().apply {
                put(DBConnection.COL2_TESTS, "chapter2")

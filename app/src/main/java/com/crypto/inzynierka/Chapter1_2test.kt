...
import com.crypto.inzynierka.databinding.FragmentChapter12testBinding

class Chapter1_2test : Fragment() {
    private var _binding: FragmentChapter12testBinding? = null
    ...
    private fun loadQuestionsFromDB() {
        ...
        val cursor: Cursor = db.rawQuery("SELECT * FROM ${DBConnection.TABLE_NAME_QUESTIONS} where Chapter= 'chapter12'", null)
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter12testBinding.inflate(inflater, container, false)
        return binding.root
    }
